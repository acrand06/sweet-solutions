...
- Determine API server for OpenShift cluster.
  ...
  - OR - [from Command line](https://github.com/IBM/zmodstack-solutions/blob/main/docs/howto/get-ocp-api-server.md)
    <!-- http://localhost:4000/sweet-solutions/2023/08/31/img/in-post/post-oel-aas/ocpabout.mp4 -->
...
- **Step 1:** Create an inventory file.
  ...
  - Create a default `inventory.yaml` and update it based on the values decided on from [Gather Target Hosts Information](#gather-target-hosts-information) above.
...
<details open>
  ...
  <div class="video-container">
  <h6>Part I - Smart deploying z/OS Cloud Broker and z/OS Package Manager</h6>
  
  <!-- <video id="video1" controls autoplay loop muted style="width: 100%;"> -->
  <video id="video1" style="width: 100%;" controls muted autoplay>
  ...
  <div class="video-container">
  <h6>Part II - View continuation of deploying IBM Open Enterprise Languages</h6>
  
  <!-- <video id="video2" controls autoplay loop muted style="width: 100%;"> -->
  <video id="video2" style="width: 100%;" controls muted>
    <!-- <source src="http://localhost:4000/sweet-solutions/img/in-post/post-oel-aas/seaa_oel_deploy_final_web.mp4" type="video/webm"> -->
        <!-- <source src="http://localhost:4000/sweet-solutions/img/in-post/post-oel-aas/seaa_oel_deploy_final.mp4" type="video/mp4"> -->
