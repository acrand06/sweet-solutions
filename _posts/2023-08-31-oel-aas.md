...
Okay so full disclosure, I did not show an "easy button", but the command used here can easily be added as part of a CI/CD pipeline to deploy open enterprise languages-aaS. Keep an eye out for future solutions post or send me any suggested topics for consideration here - sweet-solutions@gmail.com. Here are some potential future topics ...
