...
Fortunately, with the introduction of [z/OS Open Tools](https://github.com/ZOSOpenTools), and specifically tools like c3270, s3270, and x3270if, you can now streamline your interactions with ISPF by communicating from z/OS UNIX to TSO/ISPF within a single z/OS session.
